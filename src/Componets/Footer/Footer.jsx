    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-3">
          ...
          <p>
            <i className="ri-map-pin-2-fill me-2"></i> 60 29th Street San Francisco, 94110 507-Union, Trade Center, United States America
          </p>
          <p>
            <i className="ri-phone-fill me-2"></i> (+91) 9876-543-210
          </p>
          <p>
            <i className="ri-mail-fill me-2"></i> demo@example.com
          </p>
        </div>

        <div className="col-lg-6 text-start text-md-center">
        <div className="logo navbar-brand footer-logo">
                    <Link to="/" className="text-decoration-none">Leaf<span>Craft</span></Link>
                </div>
          <p className="text-white">Lorem Ipsum is simply dummy text for the reader and will be distracted by page makers.</p>
      ...
      <div className="row mt-5 pt-3 footer-bottom ">
        <div className="col-lg-6 copyright-text">
          <p>© copyright 2025. All Rights Reserved By <a href="#">K2infocom</a></p>
        </div>
